...
from models import create_session, create_task
...
def add_session(data, course_name, topic, minutes_studied, session_date, notes):
...
def mark_task_completed(task, completed_date=None):
