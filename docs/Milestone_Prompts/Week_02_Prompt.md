...
- Output folder: D:\@Coding_Projects\Python\StudyPilot\milestones\week02-decisions-and-loops

Build source:
- Prefer deriving from Week 1 and extending it
- Source path: D:\@Coding_Projects\Python\StudyPilot\milestones\week01-basic-values
...
Required behaviors:
- check task priority or completion status
- loop through several study tasks
- report whether weekly study goals are met

Not yet allowed / intentionally absent:
- functions as the central structure
- persistence
...
- Use a small fixed collection of study tasks if needed.
- Keep the logic visible and direct.
- This version should show decisions and repetition clearly, not abstract them away.
